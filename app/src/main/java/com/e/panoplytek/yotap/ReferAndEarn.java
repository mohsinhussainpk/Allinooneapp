   ...
   static Branch branch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //  simpleSeekBar = (SeekBar) findViewById(R.id.simpleSeekBar); // initiate the Seek bar
        ...
        final Button ratebtn=(Button)findViewById(R.id.ratebutton);
...
//        });
        ...
        LinkProperties linkProperties = new LinkProperties()
                .setChannel("facebook")
                .setFeature("sharing")
                .addControlParameter("$desktop_url", "https://play.google.com/store/apps/details?id=com.e.panoplytek.yotap")
                .addControlParameter("$android_url", "https://play.google.com/store/apps/details?id=com.e.panoplytek.yotap")
                .addControlParameter("$ios_url", "https://play.google.com/store/apps/details?id=com.e.panoplytek.yotap");
                    ...
                    sharebtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            try {
                                ...
                                String sAux = "\nDownload this app and get 10 rupee balance free\n\n";
                                sAux = sAux + url;
                    ...
                    ratebtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            try {
                                ...
                                Branch.getInstance().userCompletedAction("rate");
            ...
            public void onStateChanged(boolean changed, BranchError error) {
                ...
                if(credits>49)
                {
                    ...
                    btn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Toast.makeText(getApplicationContext(),"Earn minimum of 50 rupees to redeem",Toast.LENGTH_SHORT).show();
                        }
                    });
...
//                        .addContentMetadata("property2", spinner1.getSelectedItem().toString());
            ...
            @Override
            public void onStateChanged(boolean changed, BranchError error) {
                if (error == null && Branch.getInstance().getCredits() >= 50 && !phoneNumber.getText().toString().isEmpty()) {
