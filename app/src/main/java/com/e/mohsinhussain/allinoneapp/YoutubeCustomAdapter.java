...
public class YoutubeCustomAdapter extends RecyclerView.Adapter<YoutubeCustomAdapter.VideoInfoHolder> {
    ...
    public class VideoInfoHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent intent = YouTubeStandalonePlayer.createVideoIntent((Activity) ctx, "AIzaSyA_L3fFNa5nqT9P49UW7Cx0P-Fjk9hWcuQ", VideoID.get(getLayoutPosition()),100,false,true);//after this time, video will start automatically,//autoplay or not, //lightbox mode or not; show the video in a small box
